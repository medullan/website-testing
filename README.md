...
<pre>
  <code>
    pybot --outputdir robot_test_results --variable HOST:'http://medullan.com' --variable APPLITOOLS_KEY:'{Place_key_here}' --variable APPLITOOLS_APP_NAME:'Medullan' --variable SAUCE_URL:'http://{username}:{Place_Key_Here}@ondemand.saucelabs.com:80/wd/hub' --variable SAUCE_CAPABILITIES:'platform:OS X 10.9,browserName:firefox,version:33' --argumentfile full_suite.txt
  </code>
</pre>
...
<pre>
  <code>
    pybot --outputdir robot_test_results --variable HOST:'http://medullan.com' --variable APPLITOOLS_KEY:'{Place_Key_Here}' --variable APPLITOOLS_APP_NAME:'Medullan' --argumentfile er_tests.txt
  </code>
</pre>
...
<pre>
  <code>
    pybot --outputdir robot_test_results --variable HOST:'http://medullan.com' --variable BROWSER:'phantomjs' --argumentfile full_suite.txt
  </code>
</pre>
...
pybot --outputdir robot_test_results --variable HOST:'http://medullan.com' --variable SAUCE_URL:'http://{username}:{Place_Key_Here}@ondemand.saucelabs.com:80/wd/hub' --variable SAUCE_CAPABILITIES:'platform:Windows XP,browserName:internet explorer' --argumentfile full_suite.txt
